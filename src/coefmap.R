coefmap = list(
    ...
    "exposureXskill_levelstrangers only lower_skilled" = "strangers only x lower_skilled",
    "exposureXskill_levelstrangers only medium_skilled" = "strangers only x medium_skilled",
    "exposureXskill_levelstrangers only unskilled" = "strangers only x unskilled",
    ...
    "exposurestrangers only:hiscam" = "strangers x hiscm",
    ...
    "hiscam:final_meet_strangers" = "hiscam x strangers",
