...
fwrite(covid_coding[, list(label, label_clean, hisco_three = HISCO_THREE, indoors = final_under_roof, contact = final_meet_strangers, agreement)], 
    file = "../dat/exposurecoding_asinmodel.csv")
